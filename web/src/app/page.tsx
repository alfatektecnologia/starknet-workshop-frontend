...
const Page: FC = () => {
  ...
  const {
    ...
    isError: blockNumberIsError } = useBlockNumber({
  ...
  const contractAddress = "0x002ca95b283dd7069514102ca3ef66cc6b072be9ddd1f050123595931ac8d571";
  const { data: readData,
    refetch: dataRefetch,
    isError: readIsError,
    isLoading: readIsLoading,
    error: readError } = useContractRead({
